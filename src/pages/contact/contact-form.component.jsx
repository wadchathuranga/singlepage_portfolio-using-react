      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a
                href="mailto:wa.dilshan.chathuranga@gmail.com"
                target="_blank"
            ...
            <div className="m-2">
              <a
                href="https://www.linkedin.com/in/dilshan-chathuranga-2a5a291a8/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="m-2">
              <a
                href="https://twitter.com/dilshan11417382"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="m-2">
              <a
                href="https://www.facebook.com/dilshan.chathuranga.16"
                target="_blank"
                rel="noopener noreferrer"
              >
